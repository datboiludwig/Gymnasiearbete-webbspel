  ...
  for (const id in backEndProjectiles) {
    ...
    for (const playerId in backEndPlayers) {
      ...
      const DISTANCE = Math.sqrt(
        (backEndProjectiles[id].x - backEndPlayer.x) * (backEndProjectiles[id].x - backEndPlayer.x),
        (backEndProjectiles[id].y - backEndPlayer.y) * (backEndProjectiles[id].y - backEndPlayer.y)
      )
